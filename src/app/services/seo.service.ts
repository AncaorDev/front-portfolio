...
export class SeoService {
  private defaultData: SEOData = {
    ...
    description:
      'Portfolio personal de Anthony Cajacuri, desarrollador Full Stack especializado en Angular, React, Node.js y tecnologías web modernas. Descubre mis proyectos y experiencia.',
    keywords:
      'Anthony Cajacuri, desarrollador full stack, Angular, React, Node.js, JavaScript, TypeScript, portfolio, programador, desarrollo web',
    image: 'https://ancaor.com/assets/ancaor-logo.png',
    url: 'https://ancaor.com',
    type: 'website',
  };
