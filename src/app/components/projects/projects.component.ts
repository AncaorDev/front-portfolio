...
export class ProjectsComponent {
  projects: Project[] = [
    ...
    },
    {
      ...
      description:
        'Aplicación de chat en tiempo real con mensajes privados, grupos y notificaciones push.',
  ...
  //     description:
  //       'Aplicación de gestión de tareas con drag & drop, categorización y notificaciones en tiempo real.',
  ...
  //     description:
  //       'Dashboard meteorológico con pronósticos detallados, mapas interactivos y datos históricos.',
  ...
  //     title: 'Blog Platform',
  //     description:
  //       'Plataforma de blogging con editor rico, sistema de comentarios y SEO optimizado.',
  ...
  //     description:
  //       'Sitio web personal con diseño moderno, navegación horizontal y animaciones fluidas.',
